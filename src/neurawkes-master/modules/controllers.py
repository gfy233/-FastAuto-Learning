        ...
        if settings['loss_type'] == 'loglikehood':
            ...
            self.model_predict = theano.function(
                ...
                outputs = [
                    self.seq_type_event,
                    self.seq_time_values,
                    self.hawkes_ctsm.target_type,
                    self.hawkes_ctsm.type_prediction,
                    self.hawkes_ctsm.prob_over_seq_over_type,
                    # self.hawkes_ctsm.diff_type,
                    self.hawkes_ctsm.target_time,
                    self.hawkes_ctsm.time_prediction,

                    # self.seq_mask,
                    # self.hawkes_ctsm.diff_time
                    # self.hawkes_ctsm.prob_over_seq_over_type,
                    # self.hawkes_ctsm.seq_cell_target,
                    # self.hawkes_ctsm.seq_cell,
                    # self.hawkes_ctsm.seq_decay_cell,
                    # self.hawkes_ctsm.seq_gate_output,
                    # self.hawkes_ctsm.seq_emb_event,
                    # self.hawkes_ctsm.seq_time_values
                ],
                on_unused_input='ignore'
            )
